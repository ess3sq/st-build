...
//static char *font = "SF Mono:style=Light:pixelsize=28:antialias=true:autohint=true";
static char *font = "JetBrainsMono-Regular:style=Light:pixelsize=28:antialias=true:autohint=true";
